...
> run <dir>
```
Select version to run and press enter.
...
Multiple main classes detected. Select one to run:
 [1] com.juliasoft.sensors.akka.Main
 [2] com.juliasoft.sensors.future.Main
 [3] com.juliasoft.sensors.simple.Main

Enter number: 3
[info] running com.juliasoft.sensors.simple.Main src/test/resources
...
Notes:
- ...simple.Main - simple version
- ...future.Main - future powered version
- ...akka.Main - Akka stream powered version
- test data files in src/test/resources
- Additional result formatter sample: JsonResultFormatter
